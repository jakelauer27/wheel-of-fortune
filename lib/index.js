...
function aiTurn() {
  ...
  setTimeout( () => {
    ...
    setTimeout( () => {
      ...
      /////if it's a good spin, the computer will solve the puzzle if at least 2/3 of the tiles are filled in
      ////if less than 2/3 is filled in, the computer will guess.
      setTimeout( () => {
